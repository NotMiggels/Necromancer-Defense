...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("NecromancerDefense", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("NecromancerDefense", null, 1280, 720);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "NecromancerDefense";
		app.meta["name"] = "NecromancerDefense";
